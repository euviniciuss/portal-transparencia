  ...
  return (
    <div className="w-full bg-[#E6F2F9] border border-[#B3D6EB] rounded-xl p-6 md:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 my-12">
      ...
      <div className="flex flex-wrap justify-center lg:justify-end gap-3 w-full lg:w-auto">
        ...
        {/* E-SIC Button */}
        <button className="flex items-center gap-2 px-4 py-2 bg-primary text-white text-[14px] font-semibold rounded-lg shadow-sm hover:bg-opacity-90 transition-all">
